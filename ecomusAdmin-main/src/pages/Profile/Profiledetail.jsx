                        ...
                        <div className="row bg-white pb-4 round" style={{ border: '1px solid #E0E0E0', margin: "10px 0px", borderRadius: '3px' }}>
                            <div className="col-6 px-4 pt-4">
                                <div className="row">
                                    ...
                                    <div className="col-9">
                                        <p className='customcolor'>{Data.first_name && Data.last_name ? `${Data.first_name} ${Data.last_name}` : Data.first_name || ''}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-6 px-4 pt-4">
                            ...
                            <div className="col-6 px-4 pt-4">
                                <div className="row">
                                    ...
                                    <div className="col-9">
                                        <p className='customcolor'>{Data.dob ? new Date(Data.dob).toLocaleDateString('en-GB') : ''}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-6 px-4 pt-4">
                                <div className="row">
                                    ...
                                    <div className="col-9">
                                        <p className='customcolor'>{Data.mobile ? Data.mobile : ''}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-6 px-4 pt-4">
                            ...
                            <div className="col-12">
                                <div className="row">
                                    <div className="col-12 py-5 px-4 d-flex justify-content-end" style={{ gap: '4px' }}>
                                        <a href="/Editprofile"><button className='btn3'>Edit Profile</button></a>
