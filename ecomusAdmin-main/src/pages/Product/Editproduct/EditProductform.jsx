...
import { useGetAllBrandQuery } from "../../../store/api/brandapi";
const EditProductform = ({ id }) => {
  ...
  const { data: brandList, isLoading: brandLoading } = useGetAllBrandQuery();
  ...
  return isLoading === true ? (
    ...
    <div className="container-fuild pb-4 pt-3 px-2 bg-white">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-12">
                    <select
                      ...
                      disabled={brandLoading || (brands.length === 0 && !values.brand)}
                    >
                      <option value="" disabled>
                        Select Brand
                      </option>
                      ...
                      {values.brand &&
                        !brands.some((brand) => brand.brand_name === values.brand) && (
      ...
      <div className="row">
        ...
        {variantdata?.data ? variantdata.data.map((item, index) => (
          <div className="col-3">
