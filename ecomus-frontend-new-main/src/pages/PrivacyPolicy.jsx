    ...
    <div className="custom-container">
      <div className="row">
        <div className="col-lg-12 ">
          ...
          <div className="Imgverify d-flex justify-content-center" style={{position:'relative',top:'-20px'}}> <img src="./images/privacy.png" alt="img-fluid" style={{width:'27%',mixBlendMode:'darken'}} className="boyimg"/></div>
