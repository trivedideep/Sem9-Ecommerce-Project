...
const orderAnalytics = require('../Controllers/order/order_analytics')
const recommendations = require('../Controllers/order/recommendations')
const router = express.Router()

router.post('/', authenticateToken, createorder)
router.get('/', orderlist)
router.get('/analytics/summary', orderAnalytics)
